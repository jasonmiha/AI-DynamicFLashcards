...
class GeminiProcessor:
    ...
    def generate_document_summary(self, documents:list, **args):
        ...
        chain_type = "map_reduce" if len(documents) > 10 else "stuff" #stuff - one context window, map_reduce reduces documents based on summaries
...
class YoutubeProcessor:
    ...
    def find_key_concepts(self, documents:list, sample_size: int=0, verbose = False):
        ...
        if sample_size == 0:
            ...
            if verbose: logging.info(f"No sample size specified. Setting number of documents per sample to 5. Sample Size: {sample_size}")
        ...
        # Convert each JSON string n batch_concepts to a Python DIct
